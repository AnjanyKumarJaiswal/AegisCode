    ...
    async function fetchData() {
      try {
        const [riskRes, statsRes] = await Promise.all([
          fetch(`/api/v2/threats/risk-data?timeframe=${activeTimeframe}`),
          fetch("/api/v2/threats/stats"),
        ]);
      ...
      <div className="content-inner">
        ...
        <div className="card !p-10 mb-8 relative overflow-hidden group">
          <div className="flex justify-between items-start mb-16">
            <div>
              <h2 className="text-lg font-bold text-[#F5F2EE] tracking-wide mb-1">
            ...
            >
              ...
              >
                ...
                <p className="text-[8px] font-mono text-[#4A4440] uppercase">
                  {activeTimeframe === "1d" ? "Time" : "Session"}{" "}
                  {tooltip.label.replace("S", "")} - {new Date().getHours()}:00Z
                </p>
              </div>
